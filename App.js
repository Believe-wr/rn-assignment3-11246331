...
export default function App() {
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.searchContainer}>
        ...
        <TouchableOpacity style={styles.filterButton}> 
          <Image source={require('./assets/slider.png')} style={styles.filterIcon} /> 
      ...
      <View style={styles.categoriesContainer}>
        ...
        <TouchableOpacity style={styles.categoryCard}>
          ...
          <Text style={styles.categoryTitle}>Movie</Text>
          <Text style={styles.categoryTasks}>12 Tasks</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.categoryCard}>
          <Image
    ...
    <View style={styles.ongoingTasks}>
        ...
        <TouchableOpacity style={styles.taskCard}>
          <Text style={styles.taskText}>Dance Practice</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.taskCard}>
          <Text style={styles.taskText}>Learning </Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.taskCard}>
        ...
        <TouchableOpacity style={styles.taskCard}>
          <Text style={styles.taskText}>Listening to Music</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.taskCard}>
          <Text style={styles.taskText}>Watching Football</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.taskCard}>
        ...
        <TouchableOpacity style={styles.taskCard}>
          <Text style={styles.taskText}>Designing</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.taskCard}>
          <Text style={styles.taskText}>Watching Movies</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.taskCard}>
          <Text style={styles.taskText}>Reading</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.taskCard}>
          <Text style={styles.taskText}>Assignment</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.taskCard}>
          <Text style={styles.taskText}>Eating</Text>
        </TouchableOpacity>
      </View>
